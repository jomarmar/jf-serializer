...
/**
 * The Class JFSerializationTest.
 */
public class JFSerializationTest {
	
	private static final Logger logger = LoggerFactory.getLogger(JFSerializationTest.class);

	private static JFSerializer ser = new JFSerializer();
	private static JFParser parser = new JFParser();
...
//		// Parse
	...
	public void testDate() throws Exception {
		// Serialize
		JFParam par = new JFParam("testString", JFTestData.dateTest);
